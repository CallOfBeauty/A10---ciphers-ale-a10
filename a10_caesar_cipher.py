######################################################################
# Author(s): Dimitrios Ntentia, Alejandro Ramos
# Username(s): ntentiad, ramosa
#
...
class CaesarCipher:
    ...
    """
    Creates the master-class CaesarCipher, where we will be defining
    all the functions, and then call them in the main
...
def main(cipher_text1=None):
    ...
    cipher_text1 = cipher_lentulus.encrypt()                            # Encrypts the file specified in the constructor
    cipher_lentulus.export_file(cipher_text1, "friend1_letter.txt")
    ...
    cipher_text2 = cipher_marcus.encrypt()                            # Encrypts the file specified in the constructor
    cipher_marcus.export_file(cipher_text2, "friend2_letter.txt")
    ...
    cipher_text3 = cipher3.decrypt()                            # Encrypts the file specified in the constructor
    cipher3.export_file(cipher_text3, "friend3_letter.txt")
